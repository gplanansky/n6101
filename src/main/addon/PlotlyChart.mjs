...
class PlotlyChart extends Base {
    ...
    *******/
    ...
    newPlot(config) {
        ...
        if ( ! me.apiLoaded ) {
            console.log(`${me.secondsStamp()} TIMER: addon/PlotlyCharts.mjs apiLoaded FALSE  BEFORE setTimeout Plotly.newPlot`);
            // Below 200 ms Plotly.newPlot yields error:
            //    Uncaught ReferenceError: Plotly is not defined
            setTimeout(() => {
                console.log(`${me.secondsStamp()} TIMER: addon/PlotlyCharts.mjs newPlot apiLoaded FALSE setTimeout TOP`);
                ...
                console.log(`${me.secondsStamp()} TIMER: addon/PlotlyCharts.mjs newPlot apiLoaded FALSE setTimeout BOTTOM`);
                return chart
            }, 250);
           console.log(`${me.secondsStamp()} TIMER: addon/PlotlyCharts.mjs apiLoaded FALSE AFTER setTimeout Plotly.newPlot`);
        }else {
